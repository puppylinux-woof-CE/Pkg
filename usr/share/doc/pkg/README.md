...
Usage: gpkg [OPTION(S)] SEARCH|PKGNAME|BUILDSCRIPT|FILE

OPTIONS:

These two options can be used together and MUST precede all others:
...
These options can be used with --ask and --force, but they can't be 
...
These options cannot be used with any other options:
 ...
 --welcome			print a some useful cmds to help get started
